	...
	$res=mysqli_query($db,"SELECT * FROM `fine`;");
		...
		echo "<table class='table table-bordered table-hover' >";
			...
			while($row=mysqli_fetch_assoc($res))
			{
				...
				echo "<td style='background-color: white;'>"; echo $row['username']; echo "</td>";
				echo "<td style='background-color: white;'>"; echo $row['bid']; echo "</td>";
				echo "<td style='background-color: white;'>"; echo $row['returned']; echo "</td>";
				echo "<td style='background-color: white;'>"; echo $row['day']; echo "</td>";
				echo "<td style='background-color: white;'>"; echo $row['fine']; echo "</td>";
				echo "<td style='background-color: white;'>"; echo $row['status']; echo "</td>";
